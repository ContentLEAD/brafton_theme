<?php
/*
*Template Name: Social Media Archive
*/
...
$cat_posts = new WP_Query( 'cat=225,5' );

$tag_posts = new WP_Query( 'tag_id=133');
	...
	<?php } ?>
		<?php $author = brafton_author_data( get_the_ID() ); ?>
			<?php if( $i == 0 ) { ?>
				...
				<div class="inner"><h1 itemprop="name" class="title">Social Media Archive</h1></div>
			<?php } ?>
				<div class="inner">
