<?php
/*
*Template Name: Content Marketing Archive
*/
...
$cat_posts = new WP_Query( 'cat=220,48' );

$tag_posts = new WP_Query( 'tag_id=48');
	...
	<?php } ?>
		<?php $author = brafton_author_data( get_the_ID() ); ?>
			<?php if( $i == 0 ) { ?>
				...
				<div class="inner"><h1 itemprop="name" class="title">Content Marketing Archive</h1></div>
			<?php } ?>
			<div class="inner">
