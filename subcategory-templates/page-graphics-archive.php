<?php
/*
*Template Name: Graphics Archive
*/
...
$cat_posts = new WP_Query( 'cat=224,176' );

$tag_posts = new WP_Query( 'tag_id=109');
	...
	<?php } ?>
		<?php $author = brafton_author_data( get_the_ID() ); ?>
			<?php if( $i == 0 ) { ?>
				...
				<div class="inner"><h1 itemprop="name" class="title">Graphics Archive</h1></div>
			<?php } ?>
				<div class="inner">
