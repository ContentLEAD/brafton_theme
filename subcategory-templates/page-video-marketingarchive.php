<?php
/*
*Template Name: Video Marketing Archive
*/
...
$cat_posts = new WP_Query( 'cat=222,125' );

$tag_posts = new WP_Query( 'tag_id=131');
	...
	<?php } ?>
		<?php $author = brafton_author_data( get_the_ID() ); ?>
			<?php if( $i == 0 ) { ?>
				...
				<div class="inner"><h1 itemprop="name" class="title">Video Marketing Archive</h1></div>
			<?php } ?>
				<div class="inner">
