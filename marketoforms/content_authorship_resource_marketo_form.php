...
<script type="text/javascript"> function mktoGetForm() {return document.getElementById('mktForm_1197'); }</script>
<style>
...
<div class="wpcf7">
<form class="lpeRegForm formNotEmpty" method="post" enctype="application/x-www-form-urlencoded" action="http://fuel.brafton.com/index.php/leadCapture/save" id="mktForm_1197" name="mktForm_1197">
  ...
  <div class="right-col">
    <div class="f-row">
      ...
      <!--<button id='mktFrmSubmit' class="wpcf7-submit button" type="button"  onclick='formSubmit(document.getElementById("mktForm_1197")); return false;' >Submit</button>-->
      <!--<input id='mktFrmSubmit' type='submit' style="width: auto; overflow: visible; padding-left: .25em; padding-right: .25em;" value='Submit' name='submitButton' onclick='formSubmit(document.getElementById("mktForm_1197")); return false;' />-->
      <input id='mktFrmSubmit' type='submit' class="wpcf7-submit button" value='Download Now' name='submitButton' onclick='formSubmit(document.getElementById("mktForm_1197")); return false;' />
      <input style='display: none;' id='mktFrmReset' type='reset' value='Clear' name='resetButton' onclick='formReset(document.getElementById("mktForm_1197")); return false;' />
    </div>
  </div>
  ...
  <input type="hidden" name="returnURL" value= "http://fuel.brafton.com/rs/brafton/images/Authorship%20meets%20Content%20Marketing.pdf?mkt_tok=3RkMMJWWfF9wsRokvK7Nc%2B%2FhmjTEU5z17%2B4vX6a2hYkz2EFye%2BLIHETpodcMTsVjMrjYDBceEJhqyQJxPr3BKNcNwtN7RhLnCg%3D%3D&aliId=22963799" />
  <input type="hidden" name="retURL" value="http://fuel.brafton.com/rs/brafton/images/Authorship%20meets%20Content%20Marketing.pdf?mkt_tok=3RkMMJWWfF9wsRokvK7Nc%2B%2FhmjTEU5z17%2B4vX6a2hYkz2EFye%2BLIHETpodcMTsVjMrjYDBceEJhqyQJxPr3BKNcNwtN7RhLnCg%3D%3D&aliId=22963799" />
