...
<script type="text/javascript"> function mktoGetForm() {return document.getElementById('mktForm_1249'); }</script>
<style>
...
<div class="wpcf7">
<form class="lpeRegForm formNotEmpty" method="post" enctype="application/x-www-form-urlencoded" action="http://fuel.brafton.com/index.php/leadCapture/save" id="mktForm_1249" name="mktForm_1249">
  ...
  <div class="right-col">
    <div class="f-row">
      ...
      <input style='display: none;' id='mktFrmReset' type='reset' value='Clear' name='resetButton' onclick='formReset(document.getElementById("mktForm_1249")); return false;' />
    </div>
  </div>
  <span style="display:none;"><input type="text" name="_marketo_comments" value="" /></span>
	...
	<input type="hidden" name="formid" value="1249" />
  <input type="hidden" name="returnURL" value= "http://fuel.brafton.com/rs/brafton/images/Marketers_Guide_to_UX_eBook_Brafton.pdf?aliId=22963815" />
  <input type="hidden" name="retURL" value="http://fuel.brafton.com/rs/brafton/images/Marketers_Guide_to_UX_eBook_Brafton.pdf?aliId=22963815" />
...
<script>mktoMunchkin('447-XFF-352', {customName: 'MaketersGuideDownload', wsInfo: 'j1RR'});</script>
